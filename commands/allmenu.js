...
async function allMenu(sock, from, msg, session, commands) {
    // ===== HEAVY BOX HEADER =====
    let allMenuText = `┏━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━┓\n`;
    allMenuText += `┃  💀  *𝙎𝙃𝙀𝙃𝙕么𝘿𝘼 MINI ALL MENU*  💀               ┃\n`;
    allMenuText += `┣━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━┫\n`;
    allMenuText += `┃  📋 TOTAL COMMANDS: 150+                   ┃\n`;
    allMenuText += `┗━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━┛\n\n`;
    ...
    const categories = {
        ...
        '🛠️ TOOLS': ['ping', 'dp', 'vv', 'translate', 'base64', 'qr', 'shorturl', 'calc', 'weather', 'github', 'ipinfo', 'tempmail', 'fakeinfo', 'binlookup', 'whois', 'dnslookup', 'portscan', 'screenshot', 'define', 'google', 'wiki', 'yts', 'playstore', 'npm', 'sticker', 's', 'toimg', 'tomp3', 'tts', 'blur', 'invert', 'crop', 'flip', 'grayscale', 'removebg', 'enlarge', 'runtime', 'uptime', 'serverinfo', 'speedtest', 'device', 'pdf', 'ocr', 'remini', 'enhance', 'upscale', 'find', 'location', 'time', 'search'],
        ...
        '✏️ TEXT MAKER': ['𝙎𝙃𝙀𝙃𝙕么𝘿𝘼', 'cup', 'coffee', 'cloud', 'smoke', 'flower', 'leaf', 'wood', 'stone', 'blood', 'horror', 'scary', 'spooky', 'christmas', 'birthday', 'love', 'heart']
    };
    ...
    // ===== FOOTER =====
    allMenuText += `☠️  *POWERED BY : 𝙎𝙃𝙀𝙃𝙕么𝘿𝘼 MINI*  ☠️`;
